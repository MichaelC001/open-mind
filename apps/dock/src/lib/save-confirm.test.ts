...
import { confirmReduce, parseTags } from "./save-confirm";
...
describe("confirmReduce", () => {
  ...
  it("hidden → saved → confirming", () => {
    let state = { kind: "hidden" as const };
  ...
  it("confirming: type-tags updates tags", () => {
    let state = { kind: "confirming" as const, itemId: "item1", title: "Test", tags: "" };
  ...
  it("confirming: submit → saving-tags", () => {
    let state = { kind: "confirming" as const, itemId: "item1", title: "Test", tags: "tag1, tag2" };
  ...
  it("saving-tags: submit-ok → done", () => {
    let state = { kind: "saving-tags" as const, itemId: "item1", title: "Test", tags: "tag1, tag2" };
  ...
  it("confirming: dismiss → hidden", () => {
    let state = { kind: "confirming" as const, itemId: "item1", title: "Test", tags: "tag1" };
  ...
  it("saved while confirming replaces payload", () => {
    let state = { kind: "confirming" as const, itemId: "item1", title: "First", tags: "old-tags" };
